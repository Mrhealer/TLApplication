...
import com.kaity.dev.finalapplication.application.TLApplication;
import com.kaity.dev.finalapplication.data.local.DBHandler;
import com.kaity.dev.finalapplication.data.models.Comment;
import com.kaity.dev.finalapplication.data.models.Notification;
...
public class AppDataHandler implements DataHandler {
    ...
    private AppDataHandler() {
        Context context = TLApplication.getAppContext();
